...
messagemacro(BBBLOG_MSG,PS_QOS2,OVM_LOG_TOPIC,BBB_SYSLOG_PAYLOAD,"BBB Log")
...
messagemacro(POWER_STATE,PS_QOS1,RESPONSE_TOPIC,PS_BYTE_PAYLOAD,"Power State")
...
messagemacro(ENVIRONMENT,PS_QOS2,SYS_REPORT_TOPIC,PS_ENVIRONMENT_PAYLOAD,"Environment")
...
messagemacro(ODOMETRY,PS_QOS2,RAW_ODO_TOPIC,PS_ODOMETRY_PAYLOAD,"Odometry")
...
//Alert
messagemacro(ALERT,PS_QOS1,APP_REPORT_TOPIC,PS_NAME_PAYLOAD,"Alert")
