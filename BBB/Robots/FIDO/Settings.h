...
settingmacro("Pilot FastSpeed", FastSpeed, 100, 5000, 3000)
settingmacro("Pilot MediumSpeed", MediumSpeed, 100, 5000, 2000)
settingmacro("Pilot SlowSpeed", SlowSpeed, 100, 5000, 1000)
...
settingmacro("Pilot Motor TO/cm", timeoutPerCM, 0.1, 5, 1)
settingmacro("Pilot Motor Max cm", motorMaxCM, 10, 1000, 100)
settingmacro("Pilot Initial Move %", movePercentage, 0, 1.0, 0.75)
...
settingmacro("APP Max Info", maxUARTInfo, 0, 100, 50)
settingmacro("APP Max Warning", maxUARTWarning, 0, 100, 100)
settingmacro("APP Max Error", maxUARTError, 0, 100, 100)
